...
<p align="justify">
    Welcome to the <b>Emailing by Java</b> repository! This repository contains hands-on demos to help you
    understand and implement about sending emails using Java. Whether you're a beginner or an experienced
    developer, this repository will guide you step by step through essential concepts.
</p>
...
<p align="justify">
    The mail server used in these examples is <b>GMail</b>, but the code can be adjusted to work with other mail servers if
    needed.
</p>
<p align="justify">
    Before diving into Emailing by Java, ensure you're comfortable with the following concepts:
<ul>
...
<p align="justify">
    ...
    Watch the complete playlist here: <a href="https://www.youtube.com/playlist?list=PLJDwhlqmpSfNPdTXdns60uAtJRoOtjgOs"
        target="_blank"><b>Emailing by Java</b></a>.
</p>
